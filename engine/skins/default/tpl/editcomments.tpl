<div class="container-fluid">
	<div class="row mb-2">
		<div class="col-sm-6 d-none d-md-block ">
			<h1 class="m-0 text-dark">{{ lang['page-title']|default(lang['page_title']) }}</h1>
		</div>
		<!-- /.col -->
		<div class="col-sm-6">
			<ol class="breadcrumb float-sm-right">
				...
				<li class="breadcrumb-item active" aria-current="page">{{ lang['page-title']|default(lang['page_title']) }}</li>
			</ol>
		</div>
		<!-- /.col -->
	</div>
	...
	<div
		...
		<div
			...
			<div id="maincontent" class="card mb-4">
				<div class="card-header">{{ lang['maincontent'] }}</div>
				<div class="card-body">
		...
		<div id="additional" class="col col-lg-4">
			<div class="card mb-4">
				<div class="card-header">{{ lang['additional'] }}</div>
				<div class="card-body">
