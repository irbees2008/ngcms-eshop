// Lightweight toast implementation inspired by CodePen (vanilla JS)
(function () {
  ...
  function iconSVG(variant) {
    // Simple, small inline SVGs per variant
    var colors = {
      blue: "#2c7bd1",
      green: "#239c58",
      red: "#c0392b",
  ...
  // Expose globally for reuse in other templates/scripts
  window.showToast = showToast;
})();
// Note: этот файл не содержит шаблонных переменных Twig.
// Вызовите window.showToast(message, { type, title, sticked, timeout }) из шаблонов или другого JS.
