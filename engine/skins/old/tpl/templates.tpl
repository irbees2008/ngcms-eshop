<table border="0" width="100%" cellpadding="0" cellspacing="0">
	<tr>
		<td width="100%" colspan="5" class="contentHead"><img src="{{ skins_url }}/images/nav.gif" hspace="8"><a href="admin.php?mod=templates">{{ lang.templates['title'] }}</a>
		</td>
	</tr>
</table>
	...
	<table border="0" cellspacing="0" cellpadding="0" width="100%">
		<tr align="center">
			<td width="100%" class="contentNav" align="left" valign="top">
				<label><input id="selectTypeTemplate" type="radio" name="selectType" value="template" checked="checked"/>
				...
				<label><input id="selectTypePlugin" type="radio" name="selectType" value="plugin"/>
					{{ lang.templates['tplmodules'] }}</label><br/>
	...
	<table width="100%" border="0" cellaspacing="0" cellpadding="0">
		<tr>
			<td colspan="2" style="background-color: #E0E0A0; padding: 3px;">{{ lang.templates['tpl.edit'] }}
				[
				<b>
					<span id="templateNameArea">default</span>
				</b>]</td>
		</tr>
		<tr>
			<td width="230" valign="top">
				...
				<div
					style="width: 100%; background-color: #E0E0E0; padding: 3px; "><!-- <input style="width: 150px;" type="button" class="navbutton" value="Create template.."/> -->
				</div>
			</td>
			<td valign="top">
				...
				<div id="fileEditorButtonLine" style="width: 100%; background-color: #E0E0E0; padding: 3px;">
					<input style="width: 150px;" type="button" class="navbutton" value="{{ lang['btn_save'] }}" onclick="submitTemplateEdit();"/>&nbsp; &nbsp; &nbsp;
...
params: json_encode(
{template: ngTemplateName, 'file': file, token: '{{ token }}'}
)
}, function (data) {
ngHideLoading();
...
var cm = CodeMirror.fromTextArea(document.getElementById('fileEditorSelector'), {
lineNumbers: true,
// mode: i,
//         lineWrapping: true,
...
rndval: new Date().getTime(),
params: json_encode(
{template: ngTemplateName, 'file': ngFileName, token: '{{ token }}', 'content': editedContent}
)
}, function (data) {
ngHideLoading();
// Try to decode incoming data
