<script type="text/javascript">
	var ajax = new sack();
function check_connection() { // var res = document.getElementById('connection_result');
...
<form action="" method="post" name="db" id="db">
	...
	<p style="padding: 5px 0px 5px 15px;">
		...
		<table width="650" align="center" class="content">
			...
			<tr class="even">
				<td colspan="2">
					<input type="button" value="Проверить подключение к серверу БД" class="filterbutton" onclick="check_connection();">&nbsp;<br></td>
			</tr>
			<tr class="odd">
				<td colspan="2">&nbsp;</td>
			</tr>
