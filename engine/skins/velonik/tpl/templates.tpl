...
<div class="row mb-2">
	<div class="col-12">
		<ol class="breadcrumb m-0">
			...
			<li class="breadcrumb-item active">{{ lang.templates['title'] }}</li>
		</ol>
		<h4>{{ lang.templates['title'] }}</h4>
	</div>
</div>
<!-- end page title -->
		...
		<li class="nav-item dropdown">
			...
			<div class="dropdown-menu">
				{% for st in siteTemplates %}
					<a href="#" class="dropdown-item" data-teplate-mode="template" data-teplate-name="{{ st.name }}">
						{{ st.name }}
						({{ st.title }})
					</a>
				{% endfor %}
