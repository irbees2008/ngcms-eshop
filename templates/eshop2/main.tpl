			...
			<div class="fon-header">
				<header>
					<div class="top-header">
						<div class="container">
							...
							<ul class="items items-user-toolbar-top">
								<li>
									<div class="wish-list-btn tinyWishList" style="margin: 5px 15px;">
										<a {% if plugin_bookmarks_all.count > 0 %} href="{{ plugin_bookmarks_all.link }}" {% else %} disabled {% endif %}>
											<span class="js-empty empty" style="display: block">
												<span class="icon_wish_list"></span>
												<span class="text-el">
													Избранные
													{{ plugin_bookmarks_all.count }}
												</span>
											</span>
										</a>
									</div>
					...
					<div class="content-header">
						<div class="container">
							<div
								class="left-content-header t-a_j">
								<!--        Logo-->
								<div class="logo-out">
									<a href="{{home}}">
										<span class="logo">
				...
				<div
					class="frame-menu-main horizontal-menu">
												...
												<div class="frame-item-menu-out frameItemMenu">
													<div class="frame-title is-sub">
														<span class="title title-united">
															<span class="helper" style="height: 49px;"></span>
															<span class="text-el">
																Каталог
															</span>
														</span>
													...
													<div class="frame-drop-menu left-drop" id="unitedCatalog" style="display: none; left: 0px;"></div>
												</div>
											</td>
...
drop.removeAttr('style');
				...
				{% if isHandler('news:main') %}
					<div class="frame-baner frame-baner-start_page">
						<section
							class="carousel-js-css baner container cycleFrame resize is-small" style="height: 218px;">
...
$('.jcarousel-clip').css("position", "relative");
			...
			<div class="h-footer footer-main" data-mq-prop="height" data-mq-prop-pool="height" data-mq-elem-pool="footer" style="height: 456px;"></div>
		</div>
...
// initDownloadScripts(['united_scripts'], 'init', 'scriptDefer');
		...
		<button style="display: none;" type="button" data-drop="#confirm" data-confirm="true" data-effect-on="fadeIn" data-effect-off="fadeOut" class="isDrop"></button>
		...
		<div id="jq-dropdown-1" class="jq-dropdown jq-dropdown-tip">
			<ul class="jq-dropdown-menu">
				{% for cc in system_flags.eshop.currency %}
					<li {% if (system_flags.eshop.current_currency.id == cc.id) %} class="active" {% endif %}>
						<a href="{{ cc.currency_link }}">{{ cc.code }}</a>
					</li>
				{% endfor %}
			</ul>
		</div>
