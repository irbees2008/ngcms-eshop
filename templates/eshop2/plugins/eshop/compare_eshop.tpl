					...
					<div id="tab_compare-cat" class="items-carousel" data-refresh>
						<div class="left-compare">
							...
							<ul class="compare-characteristic">
								...
								<li
									data-equalhorizcell=""
									class="{% if ((loop.index % 2) == 1) %}oddC{% else %}evenC{% endif %}"
									style="height: 31px">
									<span
										class="helper helper-comp"
										data-equalhorizcell=""
													...
													<a
														...
														<span class="photo-block">
															...
															{% if (entry.images[0].filepath) %}<img
																src="{{ home }}/uploads/eshop/products/{{
																	entry.id
																}}/thumb/{{ entry.images[0].filepath }}"
																class="vImg" />{% else %}<img
																src="{{
																	home
																}}/engine/plugins/eshop/tpl/img/img_none.jpg"
																class="vImg" />{% endif %}
														</span>
                                            ...
                                            -->
														...
														<div class="frame-prices f-s_0">
															...
															<span class="current-prices f-s_0">
																...
																{% if (not (entry.variants[0].compare_price ==
																'0.00')) and (not
														...
														<div class="funcs-buttons frame-without-top">
															<div class="no-vis-table">
																{% if (entry.variants[0].stock == 0) or
																(entry.variants[0].stock == 1) %}
																...
																<div
																	class="frame-count-buy js-variant-{{
																		entry.id
																	}} js-variant">
		...
		<div class="mq-w-480 mq-min mq-block">
			...
			<div class="msg layout-highlight layout-highlight-msg">
				<div class="info">
					<span class="icon_info"></span>
					<span class="text-el"
						>При этом разрешении экрана, страница сравнения не
						отображается</span
					>
				</div>
			</div>
