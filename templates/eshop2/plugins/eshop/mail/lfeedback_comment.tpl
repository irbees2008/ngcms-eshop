<html>
	<body>
		<div style="font: normal 11px verdana, sans-serif">
			...
			Страница продукта:
			<a href="{{ vproduct.fulllink }}" target="_blank">{{ vproduct.title }}</a>
			<br />
			<h4>Отзыв:</h4>
			<table width="100%" cellspacing="1" cellpadding="1">
				...
				<tr>
					...
					<td style="background: #efefef">{{ vnames.mail }}</td>
				</tr>
				<tr>
					<td style="background: #e0e0e0"><b>Отзыв:</b></td>
					<td style="background: #efefef">{{ vnames.text }}</td>
				</tr>
			</table>
			<br />
