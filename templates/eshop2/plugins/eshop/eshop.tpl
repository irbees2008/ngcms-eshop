	...
	<div
		...
		<div class="filter left-catalog">
			...
			<div class="filter-slide  open-filter">
				...
				<script>
					$(document).ready(function () { // $('.frame-filter').nStCheck();
$('.frame-group-checks').find('.niceCheck').click(function (e) { // console.log("123");
});
});
				</script>
				<form method="post">
...
sliders.slider1 = new createObjSlider('.minCost', '.maxCost', 69, 1010, 69, 1010, 'lp', 'rp');
							...
							{% endfor %}
								...
								{% if (system_flags.eshop.features) and (cnt_in_filter) %}
									{% for ftr in system_flags.eshop.features %}
										...
										{% if ftr.in_filter == 1 and IsCatFeatures(cat_info.id, ftr.id, system_flags.eshop.categories_features) %}
											{% if ftr.ftype == 0 %}
												<div class="frame-group-checks"> <div class="inside-padd">
													<div class="title">
														<span class="f-s_0">
		...
		<div class="right-catalog">
			...
			<!-- Start. Category name and count products in category-->
				<div class="f-s_0 title-category"> <div class="frame-title">
			...
			<!--End. Banners-->
				<div class="frame-header-category"> <div class="header-category f-s_0">
					<div
						class="inside-padd">
...
cuSel(params);
						...
						<!--        Start. Show products as list or table-->
							<nav class="frame-catalog-view d_i-b v-a_t"> <ul class="tabs tabs-list-table" data-elchange="#items-catalog-main" data-cookie="listtable">
								<li class="active">
									<button type="button" data-href="tablemini" data-title="Мини таблица" data-rel="tooltip">
										<span class="icon_tablemini_cat"></span>
										<span class="text-el">Мини таблица</span>
									</button>
								</li>
								<li class="">
									<button type="button" data-href="list" data-title="Список" data-rel="tooltip">
										<span class="icon_list_cat"></span>
										<span class="text-el">Список</span>
									</button>
								</li>
							</ul>
						</nav>
			...
			<ul
				class="animateListItems items items-catalog items-product tablemini" id="items-catalog-main">
				...
				{% for entry in entries %}
					<li
						...
						<div
							...
							<div
								class="frame-without-top" style="position: relative; top: 40px;">
								<!-- Wish List & Compare List buttons -->
								<div class="frame-wish-compare-list no-vis-table t-a_j">
									<div
										class="frame-btn-comp">
