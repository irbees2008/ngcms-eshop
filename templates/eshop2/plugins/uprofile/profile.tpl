		...
		<div class="container">
			...
			<div class="left-personal f-s_0">
				<ul class="tabs tabs-data">
					<li class="active">
						<button data-href="#my_data">Основные данные</button>
					</li>
					<li class="">
						<button data-href="#history_order">История заказов</button>
					</li>
				</ul>
							...
							<div class="frame-change-profile">
								<div class="horizontal-form">
									<form
										...
										<label>
											<span class="title"
												>{{ p.xfields.fields.name.title }}:</span
											>
											<span class="frame-form-field">
										...
										<label>
											<span class="title"
												>{{ p.xfields.fields.phone.title }}:</span
											>
											<span class="frame-form-field">
										...
										<label>
											<span class="title"
												>{{ p.xfields.fields.address.title }}:</span
											>
											<span class="frame-form-field">
						...
						<div class="inside-padd">
							<table class="table-profile adaptive">
								...
								<tbody>
									...
									<tr>
										<td title="Заказ #">
											<a rel="nofollow" href="{{ order.order_link }}"
												>Заказ #{{ order.id }}</a
											>
										</td>
										<td title="Время покупки">
												...
												<span class="current-prices">
													<span class="price-new">
														<span>
															<span
																class="price"
																>{{ (order.total_price * system_flags.eshop.current_currency.rate_from)|number_format(2, '.', '') }}</span
															>
										...
										<td title="Статус платежа">
											{% if (order.paid == 0) %}Не оплачен{% else %}Оплачен{%
											endif %}
										</td>
									</tr>
									{% endfor %}
