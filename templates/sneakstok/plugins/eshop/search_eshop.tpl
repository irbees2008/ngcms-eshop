...
<div class="ui container" id="helpPanel" style="margin-top: 1em">
	<div class="ui stackable grid">
		<h3 class="ui header" style="margin-top: 10px">
			Результаты поиска: «{{ search_request }}»
		</h3>
	</div>
	<div
		class="ui divider"
...
<div class="ui stackable four column grid container">
	...
	<div class="column">
		<div class="product-preview">
			...
			{% if (entry.images[0].filepath) %}<a
				class="image"
				style="background:url({{ home }}/uploads/eshop/products/{{
					entry.id
				}}/thumb/{{ entry.images[0].filepath }}) 50% 50% /cover #eee"></a
			>{% else %}<a
				class="image"
				style="background:url({{
					home
				}}/engine/plugins/eshop/tpl/img/img_none.jpg) 50% 50% /cover #eee"></a
			>{% endif %}
...
<div class="ui container" id="helpPanel" style="margin-top: 1em">
	<div class="ui stackable grid">
		<span><b>Не найдено товаров</b></span>
	</div>
	<div
		class="ui divider"
		style="margin-top: 1.5em; border-color: #eee; border-bottom: 0"></div>
